...
- **Commits:** um por tarefa, mensagem em português no padrão `feat(gui): ...`, com o trailer `Co-Authored-By: Claude Opus 5 <noreply@anthropic.com>`. Empurre para `origin` a cada commit (política do projeto).
