...
\begin{lstlisting}[style=jsonstyle]
{
  ...
  "description": "Declarative mapping from a wide CSV file to entities and relationships of one or more SGBDs. Connection settings live in the separate SGBD configuration.",
  "type": "object",
  "required": ["version"],
  "properties": {
    "version": {
