...
O comando montado é, por padrão, \textbf{somente leitura}, e reflete apenas as opções que
diferem dos valores padrão da CLI, de modo a permanecer tão curto quanto aquilo que uma
pessoa realmente digitaria. Um \textbf{modo de edição} permite editar o texto diretamente;
