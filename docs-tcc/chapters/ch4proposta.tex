...
\begin{figure}[H]
  \centering
  \includegraphics[width=10cm]{images/figure7-overview}
...
As demais opções são facultativas e agrupam-se em três conjuntos. O primeiro controla
...
e-commerce que acompanha o repositório da ferramenta (Seção~\ref{sec:visao-geral}) --- o
mesmo cenário cujos
